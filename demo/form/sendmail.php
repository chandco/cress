...
$thanks = '<li class="sent">Thanks for the email! We&rsquo;ll get back to you as soon as possible!</li>';

//        Message for the bot when it fills in in at all.
$honeypot = "You filled in the honeypot! If you're human, try again!";

//        Various messages displayed when the fields are empty.
$emptyname =  '<li class="error">Please enter your name.</li><br />';
$emptyemail = '<li class="error">Please enter a valid email address.</li><br />';
$emptymessage = '<li class="error">Please enter a message</li>';
...
$alertmessage = '<li class="error">Making sure you aren&rsquo;t using any parenthesis or other escaping characters in the message ? Most URLS are fine though !</li>';
